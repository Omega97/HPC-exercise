#!/bin/bash
#SBATCH --job-name=ex1EPYCa01
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=128
#SBATCH --output=../logs/output_epyc_alg01.%j.out
#SBATCH --error=../logs/error_epyc_alg01.%j.err
...
output_dir="../results/"
output_file="${output_dir}barrierEPYC_alg01.csv"

barrier_algorithms=(0 1)
